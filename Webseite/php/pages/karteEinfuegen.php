<?php
require '../includes/datenbank.inc.php';
?>
...
<html>
  ...
  <body>
    ...
    <div class="content">
      <input type="checkbox" id="toggleHilfe" name="" value="">
      <div class="flow_menu">
        <label class="toggleSidebar" for="toggleHilfe">?</label>
        <div class="hilfe hilfe00 hilfeAnimate-in">
          <h3>Schritt 1: <i>Karten Name eingeben</i></h3>
          <p>Um eine Karte zu erstellen müssen Sie zuerst der Karte einen namen geben.
          </p>
        </div>
        <div class="hilfe hilfe01">
          <h3>Schritt 2: <i>Karte hochladen</i></h3>
          <p>Um eine Karte zu erstellen müssen Sie zuerst eine Karte aus ihren lokalen Dateien hochladen.
          </p>
        </div>
        <div class="hilfe hilfe02">
          <h3>Schritt 3: <i>Karte konfigurieren</i></h3>
          <p>Um eine Karte zu erstellen müssen Sie zuerst eine Karte aus ihren lokalen Dateien hochladen.
          </p>
        </div>
        <div class="hilfe hilfe03">
          <h3>Schritt 4: <i>Fertigstellung</i></h3>
          <p>Um eine Karte zu erstellen müssen Sie zuerst eine Karte aus ihren lokalen Dateien hochladen.
          </p>
        </div>
        ...
        <div id="slides">
          <div class="slide slide0">
            <div class="kartenKonfiguration">
              <form class="fKartenKonfiguration" id="fKartenKonfiguration" action="" method="post">
                <label for="kartenName">Name der Karte: </label>
                <input type="text" class="kartenName" name="kartenName" value="" placeholder="Beispiel Karte">
                <input type="submit" id="btnWeiter" name="submit" value="Weiter">
              </form>
            </div>
          </div>
          ...
          <div class="slide slide2">
            ...
            <?php
            include("../includes/FormFeld.inc.php");
             ?>
